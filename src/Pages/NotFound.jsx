...
const ErrorPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-pink-gradient">
      ...
      <Link to="/" className="bg-white text-rose-dark hover:bg-gray-200 py-2 px-4 rounded">
      Return to home page
      </Link>
    </div>
  )
