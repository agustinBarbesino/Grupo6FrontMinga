        ...
        <>
            ...
            {isOpen && (
                <div className=" fixed inset-0 z-10 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-end">
                    ...
                    <div className="relative bg-red-500 p-5 rounded flex flex-col justify-center items-center gap-4 w-full h-[88vh] md:h-[86vh] lg:h-[88vh]">
                        ...
                        <div className=" bg-white w-screen flex flex-col justify-evenly items-start gap-3 py-3">
