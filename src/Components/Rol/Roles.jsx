  ...
  return (
    <div className='w-full min-h-screen flex flex-col justify-center items-center md:flex-row'>
      <div className='w-full md:w-1/2 flex flex-col justify-center items-center'>
        ...
        <div className='w-10/12 my-4 p-1 py-2 flex justify-start items-center rounded-lg outline outline-1 outline-slate-200 hover:outline-2 hover:outline-pink-400'>
