...
const Footer = () => {
    ...
    return (
        <>
            <div className='hidden min-w-screen md:block mid:min-h-[60vh] g:min-h-[40vh]'>

                <div className='relative min-w-lg min-w-full md:min-h-[55vh] min-h-[20vh] overflow-hidden bg-gradient-to-r from-orange-800 via-sky-900 via-40% to-red-900 to-100% bg-contain bg-bottom clip-ellipse-bg '>
                ...
                <div className="flex justify-between items-center min-h-[10vh] font-montserrat pb-1">
                    <div className=" flex flex-row md:w-1/4 justify-center items-center" >
                    ...
                    <div className="flex flex-col md:w-1/6 justify-between mr-2 md:mr-10 font-montserrat">
