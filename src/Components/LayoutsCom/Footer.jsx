...
const Footer = () => {
    ...
    return (
        <>
            <div className='hidden md:block md:min-h-[40vh]'>

                <div className='relative w-full md:min-h-[55vh] min-h-[20vh] overflow-hidden bg-gradient-to-r from-orange-800 via-sky-900 via-40% to-red-900 to-100% bg-contain bg-bottom clip-ellipse-bg '>
